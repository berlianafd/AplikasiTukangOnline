						...
						<tbody>
							<?php
								...
								if(isset($_POST['qcari'])){
									$qcari=$_POST['qcari'];
									$result1 = mysqli_query($koneksi,"select count(*) from pemesanan where nama_lengkap like '%$qcari%'");
								} else {
								...
								if(isset($_POST['qcari'])){
									$qcari=$_POST['qcari'];
									$query = mysqli_query($koneksi,"SELECT  id_pemesanan, nama_kategori, nama_lengkap FROM pemesanan where nama_lengkap like '%$qcari%' limit $mulai, $batas");
								} else { 
