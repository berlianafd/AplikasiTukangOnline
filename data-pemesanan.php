...
<html>
<head>
	<title>2Kang For Life | Data Pemesanan</title>
...
<body>
	...
	<form id="search" action="data-pemesanan.php" method="post" s >
						...
						<tbody>
							<?php
								...
								if(isset($_POST['qcari'])){
									$qcari=$_POST['qcari'];
									$result1 = mysqli_query($koneksi,"select count(*) AS jumlah from pemesanan where nama_lengkap like '%$qcari%'");
									
									$result =mysqli_fetch_array($result1);
									echo "Hasil Pencarian: {$result['jumlah']} Data";
								...
								if(isset($_POST['qcari'])){
									$qcari=$_POST['qcari'];
									$query = mysqli_query($koneksi,"SELECT id_pemesanan, nama_kategori, nama_lengkap, email, nohp, kecamatan, status FROM pemesanan where nama_lengkap like '%$qcari%' limit $mulai, $batas");
...
<!-- 								<td><p><?php echo $menu['alamat'];?></p></td> -->
								...
								<td>
									<select class="badge" onchange="status(<?php echo $menu['id_pemesanan'] ?>)" 
		                                id="<?php echo 'aksistatus' . $menu['id_pemesanan'] ?>"style="width: 70%">
...
<!-- 								<td><p><?php echo $menu['jenis_tukang'];?></p></td>
								<td><p><?php echo $menu['keterangan'];?></p></td>
								<td><p><?php echo $menu['tanggal_perbaikan'];?></p></td>
								<td><img src="<?php echo $menu['gambar'];?>" width="100" heigt="100"></td> -->
								<td><p>
								
								<a href="data-pemesanan-detail.php?id=<?php echo$menu['id_pemesanan'];?>" class="btn btn-success btn-sm" role="button">
									<i class='fa fa-file'></i> </span> Edit
								</a>
|
								<a href="delete.php?id=<?php echo $menu['id_pemesanan'];?>" class="btn btn-danger btn-sm" role="button">
